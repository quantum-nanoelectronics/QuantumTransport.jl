...
geometry_params = Dict("A" => 2.866*nm*I(3), # this is the matrix of unit cell lattice vectors
		   "nx" => 9, "ny" => 3, "nz" => 1, # number of times to tile this cell over space in each direction to make whole device
		 	# "prune" =>[]  
		   "prune" => ["z"] # by default, system will set up periodic boundary conditions. This clips those hoppings
		   )
