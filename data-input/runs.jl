...
runparams = Dict(
	...
	"transport" => Dict("runtype" => "transport", "geometry" => devicegeometry, "ΔV" => 0.001, "μ" => 0.0*eV, "T" => 300, "η" => 1e-10, "save" => [:transmission, :conductance], "electrodeMagnetization" => false, "deviceMagnetization" => false, "Gʳinv_method" => :RGF, "D_spin" => 0.000001*eV, "D_momentum" => 0.000005*eV, "kspace"=>false, "E_samples" => [E for E = -1.5:0.025:1.5], "electrodeMaterial" => "metal"),
	# original - [E for E = -0.2:0.025:1.4] 
	# [E for E = -1.5:0.025:1.5]
